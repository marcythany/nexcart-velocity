...
export const mockProducts: MockProduct[] = [
	...
	},
	{
		...
		images: ['https://fakestoreapi.com/img/61mtL65D4cL._AC_SX679_t.png'],
		description:
			'Engineered for everyday running, the Nike Air Zoom Pegasus 39 delivers responsive cushioning and a secure fit. Perfect for training runs, gym sessions, and casual wear.',
	...
	},
	{
		...
		images: ['https://fakestoreapi.com/img/61IBBVJvSDL._AC_SY879_t.png'],
		description:
			'Experience the ultimate in comfort and performance with the Adidas Ultraboost 22. Featuring BOOST technology for incredible energy return and a responsive ride.',
		category: 'Sports & Outdoors',
		inStock: true,
		isNew: false,
		isOnSale: true,
	...
	},
	{
		...
		images: ['https://fakestoreapi.com/img/61U7T1koQqL._AC_SX679_t.png'],
		description:
			'Used by Roger Federer, the Wilson Pro Staff RF97 Autograph delivers precision and control. Perfect for competitive players seeking professional performance.',
		category: 'Sports & Outdoors',
		inStock: true,
		isNew: false,
		isOnSale: false,
