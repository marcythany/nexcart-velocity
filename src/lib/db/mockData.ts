...
export const mockProducts: MockProduct[] = [
	// Electronics Category
	{
		...
		rating: 4.8,
		reviewCount: 1247,
		image: '/api/placeholder?width=400&height=400&category=product',
		images: [
			'/api/placeholder?width=400&height=400&category=product',
			'/api/placeholder?width=400&height=400&category=product',
			'/api/placeholder?width=400&height=400&category=product',
		],
		description:
	...
	// Home & Kitchen Category
	{
		...
		reviewCount: 543,
		image: '/api/placeholder?width=400&height=400&category=product',
		images: ['/api/placeholder?width=400&height=400&category=product'],
		description:
