...
const ProductGrid: React.FC<ProductGridProps> = ({
					...
					<div className='grid grid-cols-1 lg:grid-cols-[256px_1fr] gap-6'>
						...
						<div className='product-grid'>
							{Array.from({ length: limit }).map((_, index) => (
								<div
									key={index}
									className='animate-pulse bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden w-full'
								>
	...
	if (error) {
		return (
			<div className={`text-center py-16 ${showFilters ? className : ''}`}>
	...
	if (showFilters) {
		return (
			<div className={className}>
				...
				<div className='grid grid-cols-1 lg:grid-cols-[256px_1fr] gap-6 mb-6'>
					{/* Filters Sidebar */}
					...
					<div className='w-full'>
						...
						{/* Product grid - FIXED: Better responsive columns and card sizing */}
						<div className='product-grid'>
